...
*   **The `.dubbiovi` Document Schema:** For long-term preservation, users export their workspace state into a native `.dubbiovi` project file. This file contains a version-controlled JSON schema detailing:
    *   `formatVersion`: The schema version (set to `1.2` in version 1.3.6).
...
> Rodríguez Fernández-Peña, A. C. (2026). *DubbiOvi (Version 1.3.6 Academic Edition)*. Alfonso Digital Lab, University of Oviedo. Persistent Identifier: https://doi.org/10.5281/zenodo.20683887
