...
const Header: React.FC<HeaderProps> = ({
  ...
  const handleCopyCitation = () => {
    const citationText = `Rodríguez Fernández-Peña, A. C. (2026). DubbiOvi (Version 1.3.2 Academic Edition). Alfonso Digital Lab, University of Oviedo. https://doi.org/10.5281/zenodo.20683887`;
        ...
        <DialogContent className="max-w-lg max-h-[85vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs font-semibold text-muted-foreground">
              v1.3.2 Academic Edition (June 2026)
            </DialogDescription>
          </DialogHeader>
